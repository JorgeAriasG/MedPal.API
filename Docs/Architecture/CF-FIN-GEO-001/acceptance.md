...
- A patient cannot enumerate or book a clinic from an unauthorized account, even when geographically close.
...
- Booking revalidates membership, radius, clinic/doctor relationship, and slot overlap atomically.
