...
- [ ] T01 Capture endpoint/database contract tests and cross-account denial tests.
- [ ] T02 Approve patient-account eligibility, radius, Connect merchant boundary, and provider-storage decisions.
