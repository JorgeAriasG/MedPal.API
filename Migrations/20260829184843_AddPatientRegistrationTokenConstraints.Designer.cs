...
namespace MedPal.API.Migrations
{
    ...
    [Migration("20260829184843_AddPatientRegistrationTokenConstraints")]
    partial class AddPatientRegistrationTokenConstraints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedPal.API.Models.PatientRegistrationToken", b =>
                {
                    b.HasOne("MedPal.API.Models.Patient", null)
                        .WithMany()
                        .HasForeignKey("PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
